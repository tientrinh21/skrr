...
<nav
	class={cn(
		'mx-2 flex items-baseline justify-between rounded-none rounded-b-xl border-2 border-t-0 py-3 pl-4 pr-7 shadow-md dark:shadow-muted sm:py-5 lg:mx-5 lg:px-10',
		className,
	)}
>
